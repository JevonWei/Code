...
// var Persistence Persistence1 = NewJSONFile(UserFile)

// var Persistence Persistence1 = NewGlobFile(UserFile)
var Persistence Persistence1
...
func SetPersistence(type_ string) {
	...
	case "gob":
		Persistence = NewGlobFile(UserFile)
	}
}
