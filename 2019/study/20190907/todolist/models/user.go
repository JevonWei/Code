...
func ValidateCreateUser(name, password, passwordVerify, birthday, tel, addr, desc string) map[string]string {
...
func ModifyPasswd(name, passwd, passwordVerify string) string {
	var user User
	var passwd_md5 string
	if passwd == passwordVerify {
